...
* inviteURI : String starting with https://beforeve.com/#
...
* GroupInviteLink<s> (read-only) : String of the invitation link (starts with https://beforeve.com/#)
...
Resets the group's invitation link to a new random URL starting with https://beforeve.com/#
